package com.ms.trivia.endpoints;

import com.ms.trivia.model.TriviaQuestion;
import com.ms.trivia.model.TriviaQuestionAccessible;
import com.ms.trivia.model.TriviaQuestionArrayAccess;
    ...
    public Response getQuestion(@Context UriInfo uri, 
        ...
        if (idString.trim().equalsIgnoreCase("random")) {
            ...
            response = Response.ok(question)
                               .lastModified(question.getLastModified())
                               .location(uri.getRequestUri())
                               .build();
        } else {
            try {
